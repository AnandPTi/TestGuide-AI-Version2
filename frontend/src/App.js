...
// import React, { useState } from 'react';
// import axios from 'axios';
// import { Button, CircularProgress, Typography, Box, Card, CardMedia, Grid } from '@mui/material';
// import { styled } from '@mui/system';
// import ReactMarkdown from 'react-markdown';
...
//       console.log("Backend response:", res.data);  // Log the response to check structure
//       setResponse(res.data['Generated Instructions'] || res.data['GeneratedInstructions'] || res.data['generated_instructions']);
//     } catch (err) {
...
//           style={{ marginTop: '20px' }}
//         >
//           {loading ? <CircularProgress size={24} color="inherit" /> : 'Generate Test'}
//         </Button>
...
//         <h1>Generative AI Testing Instructions</h1>
//       </header>
